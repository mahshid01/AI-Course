...
| Mahshid SHoeibi       | Backend Logic Developer                     | Implementation of metabolic calculations, edge-case handling, and integration of algorithmic logic with system workflow (`diet_logic.py`)                                               |
